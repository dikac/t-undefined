...
export default class NotUndefined<Msg> implements ValidatorAbstract<unknown, undefined, Readonly<Instance<unknown, Msg, true>>, Readonly<Instance<undefined, Msg, false>>>, Message<Function<[Readonly<Value> & Readonly<Validatable>], Msg>> {
