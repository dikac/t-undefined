...
export default class Undefined<MessageT> implements Validator<unknown, undefined, Readonly<ValidatorValidatable<unknown, MessageT>>>, Message<Function<[Readonly<Value & Validatable>], MessageT>> {
